...
- **`dockermenu.py`**: Command-line script for managing Docker Compose tasks (e.g., start, stop, and build containers).

- **`gitmenu.py`**: Command-line interface for managing Git version control tasks such as pull, push, and branch management.
